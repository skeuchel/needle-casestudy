...
Proof.
  induction m; intros Γ T1 T2 Δ wtp wt1 wt2; isimpl.
  - dependent destruction wtp.
    eauto using subst_evar_Typing with infra.
  - dependent destruction wtp. dependent destruction wt1. isimpl.
    eapply IHm2; eauto.
    eapply IHm1; eauto.
    rewrite <- (domain_PTyping_bindPat _ _ _ _ wtp1) in *.
